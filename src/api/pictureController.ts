...
/** createPictureTask POST /api/picture/AiPicture/create_task */
export async function createPictureTaskUsingPost(
  body: API.CreateAIPictureTaskRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseCreatePictureTaskResponse_>('/api/picture/AiPicture/create_task', {
    method: 'POST',
    headers: {
...
/** getPictureTask GET /api/picture/AiPicture/get_task */
export async function getPictureTaskUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureTaskUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetPictureTaskResponse_>('/api/picture/AiPicture/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** getPictureVOByUserId GET /api/picture/getByUserId */
export async function getPictureVoByUserIdUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseListGalleryStatisticsVo_>('/api/picture/getByUserId', {
    method: 'GET',
    ...(options || {}),
  })
}

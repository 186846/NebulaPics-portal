<template>
  <div id="addPicturePage">
    ...
    <a-tabs v-model:activeKey="uploadType">
      ...
      <a-tab-pane key="prop" tab="AI图片创建" force-render>
        <AIPicture />
      </a-tab-pane>
    </a-tabs>
    <!-- 图片编辑 -->
    <div v-if="picture" class="edit-bar">
      <a-space size="middle">
        ...
        <!-- 加水印 -->
        <!-- 加水印 -->
        <a-button :icon="h(EditOutlined)" @click="doAddWatermark">加水印</a-button>
      </a-space>
      <ImageCropper
        ref="imageCropperRef"
...
const doAddWatermark = async () => {
  watermarkRef.value?.openModal()
}

// 加水印成功事件
const onWatermarkSuccess = (newPicture: API.PictureVO) => {
  picture.value = newPicture
}
